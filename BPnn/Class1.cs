...
namespace BPnn
{
    ...
    {
        //连接数据库的命令
        //port 一般是3306，我这里是3308
        //user 一般是root
        //password 密码
        //database 用的数据库的名字，这里用的是test1
        public static String connetStr1 = "server=127.0.0.1;port=3308;user=root;password=123456; database=test1;";
        ...
        public double Hello1(double a1, double a2, double a3)
        {
