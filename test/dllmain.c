...
/**************修改如下值*******************/
#define In 3    //输入层In个节点
#define Hide 7  //隐藏层Hide个节点
#define Out 1   //输出层Out个节点
#define N 12    //每次训练N组数据
#define Ntest 1    //每次测试Ntest组数据
#define Err_max  0.000001 //允许的误差精度
#define rate  0.1 //学习速率
#define In_divisor  1000 //输入除数 保持所有输入数据在-1~1内
#define Out_divisor  1000 //输出除数 保持所有输出数据在-1~1内
...
//DLLIMPORT __declspec(dllexport) double Hello( )
{
